...
## Overview
This project analyzes trends in Netflix content using two datasets. The goal of this analysis is to better understand patterns in Netflix's catalog, including the types of content that appear most frequently, how content has changed over time, and how factors such as genre, country of origin, and runtime relate to audience ratings and award nominations.
...
### WHAT
- What portion of Netflix’s catalog is TV Shows vs Movies?
- What genres appear most frequently in the Netflix catalogue?
- What’s the average runtime for Netflix movies?
- What genre received the most nominations for awards?
- What genre has the highest average IMDb rating?

### WHEN
- When was the year with the most titles added? (date_added)
- What is the year with the most content? (release_year)

### WHERE
- Where is the most common country of origin of TV Shows/Movies?
- Where are Netflix titles with longer runtimes most commonly produced?
- Where was the country that had the most titles nominated for awards?
